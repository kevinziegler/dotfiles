...
# typeset -g POWERLEVEL9K_VI_MODE_VISUAL_FOREGROUND="yellow";
# typeset -g POWERLEVEL9K_VI_MODE_BACKGROUND="clear";

# typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_LEFT_SUFFIX="❯";
